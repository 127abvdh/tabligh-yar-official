  ...
  <div class="container">
    ...
    <div class="hero">
      ...
      <div class="buttons">
        ...
        <a href="/business-request.html" class="btn btn-secondary">تبلیغ کسب و کار</a>
...
<head>
  ...
  <style>
    ...
    .account { background: #d4edda; padding: 15px; border-radius: 8px; margin-bottom: 20px; text-align: center; font-weight: bold; }
...
<body>
  <div class="form">
    <h1>تبلیغ کسب و کار</h1>
    <div class="account">حساب: IR360190000000216518589002</div>
    <form id="form">
      <div class="group">
      ...
      <div class="group">
        ...
        <select id="package" required>
          <option value="sixMonth">6 ماه - 1,800,000 تومان</option>
          <option value="oneYear">1 سال - 3,600,000 تومان</option>
        </select>
      </div>
      <div class="group">
  ...
  <script>
    document.getElementById('form').addEventListener('submit', async (e) => {
      ...
      if (data.success) {
        msg.textContent = 'کد: ' + data.refId + ' - منتشر شد! لطفا مبلغ را واریز کنید';
      }
    });
  </script>
</body>
...
<body>
  ...
  <script>
    async function load() {
      ...
      const data = await res.json();
      if (data.length === 0) {
        document.getElementById('grid').innerHTML = '<p>تبلیغی وجود ندارد</p>';
        return;
      }
      data.forEach(b => document.getElementById('grid').innerHTML += '<div class="card"><h3>' + b.businessName + '</h3><p>' + b.businessAddress + '</p><p>شماره: ' + b.businessPhone + '</p></div>');
    }
    load();
  </script>
</body>
